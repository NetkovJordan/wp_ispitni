...
public class EventsController {
    ...
    public String showEvents(@RequestParam(required = false) Double price,
                             @RequestParam(required = false) EventType type, Model model) {
        //tuka ti e greskata, seti se so e :)
    ...
    public String showAdd(Model model) {
        List<EventLocation> eventLocations = this.eventLocationService.listAll();
        model.addAttribute("locations",eventLocations);
        model.addAttribute("types",EventType.values());
        return "form";
    }
